    ...
    def create_test_success(self):
        ...
        if self.token:
            ...
            for question in self.questions_data:
                ...
                assert update_response.status_code == 200, f"Failed -update question, id={question_id}), {update_response.status_code}"
            ...
            if(test_with_questions.status_code == 200):
                ...
                assert response_public.status_code == 200,f"failed delete test {self.testCode}) {response_public.status_code}"
                ...
                assert delete_response.status_code == 204, f"failed- delete test,{delete_response.status_code}"
            ...
            print("Skip test creation- failed smth")
